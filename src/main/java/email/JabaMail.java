...
/** Standalone Mail Client GUI application.
 * @author	Ian Darwin, ian@darwinsys.com
 * @version $Id$
 */
public class JabaMail extends JComponent implements MailConstants {
	/** The quit button */
	JButton quitButton;
	/** The read mode */
	MailReaderBean mrb;
	...
	/** Construct the JabaMail JComponent a default Properties filename */
	public JabaMail() throws Exception {
		this(PROPS_FILE_NAME);
	}

	/** Construct the JabaMail JComponent with no Properties filename */
	public JabaMail(String propsFileName) throws Exception {
		super();
	...
	public static void main(String av[]) throws Exception {
		...
		// create a JabaMail object
		JabaMail comp;
		if (av.length == 0)
			comp = new JabaMail();
		else
			comp = new JabaMail(av[0]);
