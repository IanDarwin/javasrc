...
The minimum Java release is currently 21. You can compile for Java 17 by checking out the java-17 tag.
Or you can just add exclusions for files that use newer features.
For older releases, I don't seem to have tags, so if somebody can bisect and tell me what works for 17,
