...
var MYFMT = StringTemplate.Processor.of((StringTemplate st) -> {
	...
	// The constructed StringTemplate has two array fields,
	// fragments (the parts not in \{...}) and values.
...
System.out.println(MYFMT."Hello %s\{user}, Math.PI to 5 decimal places is %7.5f\{Math.PI}.");
}
