...
public class ObjectFactory {
    ...
    private final static QName _Divide_QNAME = new QName("http://toy.service/", "divide");
    private final static QName _Multiply_QNAME = new QName("http://toy.service/", "multiply");
    private final static QName _Add_QNAME = new QName("http://toy.service/", "add");
    private final static QName _DivideResponse_QNAME = new QName("http://toy.service/", "divideResponse");
    private final static QName _SubtractResponse_QNAME = new QName("http://toy.service/", "subtractResponse");
    private final static QName _Subtract_QNAME = new QName("http://toy.service/", "subtract");
    private final static QName _AddResponse_QNAME = new QName("http://toy.service/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://toy.service/", "multiplyResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://toy.service/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://toy.service/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://toy.service/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://toy.service/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://toy.service/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://toy.service/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://toy.service/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://toy.service/", name = "multiplyResponse")
